...
def scrabble(word):
    ...
    totalScore += checkScore(word,scoreOne,points1) + checkScore(word,scoreTwo,points2) + checkScore(word,scoreThree,points3) + checkScore(word,scoreFour,points4) + checkScore(word,scoreEight,points8) + checkScore(word,scoreTen,points10)
