...
def scrabble(word):
    ...
    totalScore = totalScore + checkScore(word,scoreOne,points1) + checkScore(word,scoreTwo,points2) + checkScore(word,scoreThree,points3) + checkScore(word,scoreFour,points4) + checkScore(word,scoreEight,points8) + checkScore(word,scoreTen,points10)
...
def checkScore(string,scoreArr,pointValue):
    ...
    for i in range(0,len(scoreArr)):
        ...
        print('array val ' + str(scoreArr[i]))
    print('return score ' + str(score))
    return score
'''
