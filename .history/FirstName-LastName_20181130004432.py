...
def pangram(sentence):
    ...
    subsetStr0 = {'.' , ' ' , ',' , ','}
    subsetStr = 'abcdefghijklmnopqrstuvwxyz'
    print(''.join(sentence_list.difference(subsetStr0)))
    return ''.join(sentence_list.difference(subsetStr0)).__contains__(subsetStr)
